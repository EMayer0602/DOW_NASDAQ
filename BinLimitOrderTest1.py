...
# Preis bewusst etwas unter Markt (~92.500), aber nicht zu extrem -> z.B. 85.000
order = place_limit_order("BTCUSDT", "BUY", 0.001, 85000)
print(order)
...
if "orderId" in order:
    ...
    print("\n❌ Order konnte nicht erstellt werden:", order)
